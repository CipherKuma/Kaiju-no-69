import { useQuery, useMutation, useQueryClient, UseQueryOptions, useInfiniteQuery, UseInfiniteQueryOptions, InfiniteData } from '@tanstack/react-query';
...
export const useTradingFeed = (
  ...
  options?: Omit<UseInfiniteQueryOptions<PaginatedResponse<TradeExecution>, Error, InfiniteData<PaginatedResponse<TradeExecution>>, any, number>, 'queryKey' | 'queryFn' | 'getNextPageParam' | 'initialPageParam'>
) => {
